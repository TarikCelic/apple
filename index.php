...
<body>
    ...
    <a href="#" class="air">
        <div class="air-box">
            <h2>iPhone Air</h2>
            <p>Explore the thinniest iphone ever</p>
        </div>
        <div class="image-wrapper-air"></div>
    </a>

    <hr class="w-48 h-1 mx-auto my-4 bg-neutral-quaternary border-0 rounded-sm md:my-10" style="background-color:#d8d8d8">
    ...
    <footer class="bg-neutral-primary">
        ...
        <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
                <h2 class="mb-6 text-sm font-semibold text-heading uppercase">Apple Wallet</h2>
                <ul class="text-body font-medium">
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Wallet</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Apple Card</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Apple Pay</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Apple Cash</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="text-body font-medium">
                    <li class="mb-4">
                        <a href="login.php" class="hover:underline">Manage Your Apple Account</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Apple Store Account</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">iCloud.com</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="text-body font-medium">
                    ...
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Apple Leadership</a>
                    </li>
                    <li class="mb-4">
                        <a href="#" class="hover:underline">Investitors</a>
                    </li>
                    <li class="mb-4">
        ...
        <div class="px-4 py-6 bg-neutral-secondary-soft md:flex md:items-center md:justify-between">
            <span class="text-sm text-body sm:text-center">© 2025 <a href="https://apple.com/">Apple Inc.</a> All Rights Reserved.
            </span>
